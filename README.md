...
### React / Electron app for parsing JSON files exported from company software
...
```bash
git clone https://github.com/perezvon/json-parser.git
```
...
- [John A Maloney](https://github.com/perezvon)
